...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function (){
            $.post(
                "admin/canteen_manage","", function (resq){
                    $.each(resq,function (i,n){
                        $("#advantages").append("<div class='c'><p class='p'>"+n.advantages+"</p></div>");
                        $("#disadvantages").append("<div class='c'><p class='p'>"+n.disadvantages+"</p></div>");
                        $("#advice").append("<div class='c'><p class='p'>"+n.advice+"</p></div>");
                    })
                }, "json");
        })
    </script>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row layui-anim layui-anim-upbit">
            <div class="layui-col-md4" id="advantages">
                <h3 align="center"><b>食堂的优点</b></h3>
                <div class="layui-icon layui-icon-ok" style="text-align: center;"></div>
            </div>
            <div class="layui-col-lg4" id="disadvantages">
                <h3 align="center"><b>食堂的缺点</b></h3>
                <div class="layui-icon layui-icon-close" style="text-align: center;"></div>
            </div>
            <div class="layui-col-lg4" id="advice">
                <h3 align="center"><b>建议</b></h3>
                <div class="layui-icon layui-icon-email" style="text-align: center;"></div>
            </div>
        </div>
    </div>
</body>
