...
<head>
    ...
    <script type="text/javascript">
        $(function (){
            $.post(
                "admin/advicebox_manage", "",function (resp){
                    $.each(resp,function (i,n){
                        $("#box").append("<div class='c'><p class='p'>"+n.advice+"</p></div>")
                    })
                }, "json")
        })
    </script>
...
<body >
    <div class="container">
        ...
        <div class="row">
            <div class="layui-col-md8 layui-col-md-offset2 layui-anim layui-anim-upbit" id="box">
                <h3 align="center"><b>意见箱</b></h3>
                <div class="layui-icon layui-icon-release" style="text-align: center;"></div>
            </div>
        </div>
    </div>
</body>
