        ...
        <form class="layui-form" style="font-size: 20px" method="post" action="admin/goodsadd" name="myform" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="layui-input-block">
                    &nbsp;&nbsp;&nbsp;
                    <input type="radio" name="type" value="1" title="零食" disabled >
                    <input type="radio" name="type" value="2" title="生活用品" checked>
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" name="gid" id="gid" placeholder="请输入以2开头的4位零食商品编号" onblur="checkGid()">
                </div>
                <p id="gid_message"></p>
            </div>
            <br>
            ...
            <div class="row">
                <div class="col-md-2 col-lg-offset-4">
                    <img src="images/livinggoods/充电宝.jpg" id="img" name="img" width="240px" height="240px">
                </div>
            </div>
            <br>
            <div class="row">
