...
<html>
    <head>
        ...
        <script type="text/javascript">
            $(function (){
                $.post("admin/livingindex_manage",{type:"0"},function (resp){
    ...
    <body >
        <div class="container">
            ...
            <form class="form-inline">
                ...
                <div class="form-group layui-col-md-offset7">
                    <a href="admin/goods_manage/livinggoods_add.jsp" style="font-size: 20px">上新</a>
                </div>
            </form>
        ...
        <script type="text/javascript">
            ...
            function searchPage(type){
                $.post("admin/livingindex_manage",{type:type},function (resp){
                    if(resp == null && type == 1){
                        alert("当前为首页 没有上一页")
