...
<body>
    ...
    <div class="layui-container">
        <div class="layui-icon">
            <h2 align="center">一&nbsp;卡&nbsp;通&nbsp;&nbsp;&nbsp;&#xe62a;</h2>
        </div>
        <div class="layui-row" style="margin-top: 30px;">
            <form class="layui-form" action="user/updateCardQuantity" method="get" lay-filter="example" style="font-size: large;">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <div class="layui-col-md3">
                            <input type="text" class="layui-input" id= "sno" name="sno"  lay-verify="required" placeholder="请输入学号" pattern="0[0-9]{7}" oninvalid="setCustomValidity('请输入以0开头的8位学号')" oninput="setCustomValidity('')">
                        </div>
                        &nbsp;&nbsp;&nbsp;
                        <div class="layui-col-md3 ">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <div class="layui-col-md3">
                            <button type="button" class="layui-btn" lay-submit="" lay-filter="" onclick=queryQuantity()>查询一卡通余额</button>
                        </div>
                    </div>
                </div>
