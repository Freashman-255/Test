...
<script type="text/javascript">
    function btn_add(food_name,price,img_src) {
        /*let label=$("#label").text();
        label++;
        $("#label").html(label);*/
        $.ajax({
            url:"user/insertBuyList",
            data:{"food_name":food_name,"price":price,"img_src":img_src},
        ...
        $.ajax({
            ...
            success:function (response) {
                ...
                $.each(response.data,function (index,element) {
                    let tr=document.createElement("tr");
                    tr.innerHTML+="<td>"+element.food_name+"</td>"+
                        "<td>"+"<img src="+element.img_src+" width=120px height=80px"+"/>"+"</td>"+
                        "<td>"+element.price+"</td>"+
                        "<td>"+"<button class='btn-primary form-control' onclick=\"btn_add(\'"+element.food_name+"\',\'"+element.price+"\',\'"+element.img_src+"\')\" style='width: 120px;height:40px'>"+"添加到购物车"+"</button>"+"&nbsp;"+
                        "</td>"+
    ...
    $(function () {
        ...
        next_page.onclick=function () {
            ...
            if (cur_page!=page_count){
                $.ajax({
                    url: "user/canteenQueryPage",
                    data:{"page":cur_page*4},
                    dataType:"json",
                    success:function (data) {
                        //console.log(data);
                        //清除掉上一页的数据以便这一页的数据展示
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-md-offset-10">
            <a class="btn btn-default" href="user/canteen/shopCar.jsp" ><img src="images/shopping_cart.png" height="50px" width="50px" >
