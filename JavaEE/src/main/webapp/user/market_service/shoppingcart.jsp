...
<html>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $.ajax({
                url:"user/selectAllBuyGoodsListService",
                dataType:"json",
                success:function (response) {
                    let div=$("#div");
                    ...
                    $.each(response,function (index,element) {
                        ...
                        tr.innerHTML+="<td>"+id+"</td>"+
                            ...
                            "<td>"+element.price+"</td>"+
                            "<td>"+"<button class='btn-danger form-control' onclick=\"btn_delete(\'"+id+"\',\'"+element.gname+"\')\" style='width: 120px;height:40px'>"+"从购物车删除"+"</button>"+"&nbsp;"+
                            "</td>";
                        table.appendChild(tr);
        ...
        <div class="container">
            ...
            <div class="row layui-icon">
                <ul class="layui-nav">
                    ...
                    <li class="layui-nav-item"><a href="user/appraise.jsp">评价</a></li>

                    <li class="layui-nav-item layui-col-xs-offset4" lay-unselect="">
                        <a href="javascript:;"><img src="images/myhead.jpg" class="layui-nav-img"></a>
                        <dl class="layui-nav-child">
                            <dd><a href="user/personintrouction.jsp">编辑个人资料</a></dd>
                            <dd style="text-align: center;"><a href="http://www.baidu.com">退出&#xe682;</a></dd>
                        </dl>
                    </li>
                </ul>
            </div>
